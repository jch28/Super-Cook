...
const CustomHeader = () => (
  <View style = {{flexDirection: 'row'}}>
    ...
    <View style = {{flexDirection: 'column'}}>
      <Text style={{paddingBottom:2, color: 'white', fontSize: 21, fontWeight: 'bold'}}>{"  Seafoods"}</Text>
    </View>
  </View>
);

export default class Seafoods extends React.Component {
  state = {
    checked: false,
  };
  ...
  render() {
    return (
      ...
      <SeafoodsList changed = {this.change.bind(this)} deleted = {this.rem.bind(this)}/>
      </View>
    )
  }
}
