...
const CustomHeader = () => (
  <View style = {{flexDirection: 'row'}}>
    ...
    <View style = {{flexDirection: 'column'}}>
      <Text style={{paddingBottom:2, color: 'white', fontSize: 21, fontWeight: 'bold'}}>{"  Liquids"}</Text>
    </View>
  </View>
);

export default class Liquids extends React.Component {
  state = {
    checked: false,
  };
  ...
  render() {
    return (
      ...
      <LiquidsList changed = {this.change.bind(this)} deleted = {this.rem.bind(this)}/>
      </View>
    )
  }
}
