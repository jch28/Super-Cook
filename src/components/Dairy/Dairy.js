...
import DairyGrid from './DairyGrid';
...
const CustomHeader = () => (
  <View style = {{flexDirection: 'row'}}>
    ...
    <View style = {{flexDirection: 'column'}}>
      <Text style={{paddingBottom:2, color: 'white', fontSize: 21, fontWeight: 'bold'}}>{"  Dairy"}</Text>
    </View>
  </View>
);
...
export default class Dairy extends React.Component {
  ...
  render() {
    return (
      ...
      <DairyList changed = {this.change.bind(this)} deleted = {this.rem.bind(this)}/>
      </View>
    )
  }
}
